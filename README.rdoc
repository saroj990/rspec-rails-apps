...
* How to use the application.
 ...
 2.>  bundle install to update the gems and dependencies
 3.>  rake db:migrate to run migrations.
 4.>  rspec or rspec -f d to run the spec.

 How to get Started with rspec.
 These are a few references that may guide you to learn rspec in better way.



 For fundamental idea on rspec:
 	If you want start learning rspec from scratch i recommened you to hava look at this links.
